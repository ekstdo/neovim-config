...
return {
  ...
  -- ),
  -- s(
  --   { trig = "prob", dscr="probability", snippetType="autosnippet", wordTrig=false },
  --   fmta("\\mathbb{P}(${1:\\text{$2}})<>", {i(1), i(2), i(0)}),
  --   { condition = is_math_mode, show_condition = is_math_mode }
  -- ),
  ...
  s(
    ...
    fmta("\\mathcal{<>}", {f( function(_, snip) return snip.captures[1] end )}),
    { condition = is_math_mode, show_condition = is_math_mode }
  ),
  s(
  ...
  s(
    { trig = "([%a]+[%d_]?%d?)bb", snippetType="autosnippet", wordTrig=false, regTrig=true },
    fmta("\\mathbb{<>}", {f( function(_, snip) return snip.captures[1] end )}),
    { condition = is_math_mode, show_condition = is_math_mode }
  ),
  s(
    { trig="rarr", dscr="rightarrow", snippetType="autosnippet", wordTrig=true},
    fmta("\\rightarrow", {}),
    { condition=is_math_mode, show_condition=is_math_mode }
  ),
  s(
  ...
  -- ),
  -- ls.parser.parse_snippet(
  --   { trig="zq", dscr="set", wordTrig=false},
  --   "\\{$1 \\\\} $0",
  --   { condition=is_math_mode, show_condition=is_math_mode }
  -- ),
  -- ls.parser.parse_snippet(
